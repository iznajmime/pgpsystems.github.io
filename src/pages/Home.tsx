...
const Home = () => {
  ...
  return (
    <div className="space-y-24 md:space-y-32 lg:space-y-40 pb-12">
      {/* Hero Section */}
      <section className="w-full pt-12 md:pt-24 lg:pt-32">
        <div className="container px-4 md:px-6 space-y-10 xl:space-y-16">
          <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
            <div className="flex flex-col justify-center space-y-4 text-center md:text-left">
              <h1 className="lg:leading-tighter text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-[3.4rem] 2xl:text-[3.75rem] fade-in-up">
                Stop Wasting Time. Start Automating with AI.
              </h1>
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400 fade-in-up" style={{ animationDelay: '0.2s' }}>
                PGP Systems builds custom AI solutions that reclaim your valuable time and slash operational costs. Let us handle the repetitive tasks, so you can focus on growth.
              </p>
              <div className="space-x-4 mt-6 fade-in-up" style={{ animationDelay: '0.4s' }}>
      ...
      <section className="w-full">
        <div className="container px-4 md:px-6">
          ...
          <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400 text-center mt-4 fade-in-up" style={{ animationDelay: '0.2s' }}>
            Explore how we've transformed businesses through intelligent automation.
          </p>
      ...
      <section id="contact" className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-900/50">
